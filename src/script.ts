...
function buildIngredientTooltipText(ingredient: IngredientData): HTMLElement {
  ...
  if (ingredient.garden != null) {
    container.appendChild(document.createElement('br'));
    const gardenDiv = document.createElement('div');
    gardenDiv.style.display = 'flex';
    gardenDiv.style.alignItems = 'center';
    gardenDiv.style.gap = '4px';
    gardenDiv.innerHTML = `
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#0b7609ff" width="14" height="14">
        <g>
